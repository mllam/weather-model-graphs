"""
Rectilinear mesh layout: coordinate creation for uniform rectangular grids.

Uses ``networkx.grid_2d_graph`` to produce a rectilinear lattice with
4-star (cardinal) and 8-star (cardinal + diagonal) spatial adjacency edges.
