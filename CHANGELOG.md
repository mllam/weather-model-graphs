...
- Added `crop_to_convex_hull` option to `mesh_layout_kwargs` to prune mesh nodes outside the spatial boundary of grid coordinates using Delaunay triangulation (#58) @AdMub
